...
urlpatterns = [
    ...
    path('authentication/change-password/<int:id>',
         views.update_user_password, name="updateUserPassword"),
    ...
    path('get-sport-hall-reservations', views.get_sport_hall_reservations,
         name='getSportHallReservations'),
    path('get-friends', views.get_friends, name='getFriends'),
    path('reservation', views.reservation, name='reservation'),
    path('get-permanent-teams', views.get_permanent_teams,
         name='getPermanentTeams'),
    path('get-users', views.get_users, name='getUsers'),
    path('get-invited-users', views.get_invited_users, name='getInvitedUsers'),
    path('invite-temporary-team', views.invite_temporary_team,
         name='inviteTemporaryTeam'),
    ...
    path('sport-hall/<int:owner_id>/<int:sporthall_id>',
         views.get_sport_hall, name='getSportHall'),
    ...
    path('player/change-profile-photo/<int:id>',
         views.update_player_photo, name="updateUserPhoto"),

    path('contact-us', views.contact_us, name='contactUs'),

    path('player/invitation/<int:id>',
         views.get_player_invitations, name="getPlayerInvitations"),
    path('player/update-invitation-status/<int:invitation_id>',
         views.update_invitation_status, name="updateInvitationStatus"),
    path('player/friends/<int:id>',
         views.get_player_friends, name="getPlayerFriends"),
    path('player/delete-friend/<int:id>',
         views.delete_player_friend, name="deletePlayerFriends"),
    path('player/games/<int:user_id>',
         views.get_player_games, name="getPlayerGames"),
    path('player/delete-friend/<int:id>',
         views.delete_player_friend, name="deletePlayerFriend"),
    #     path('player/sort-invitations/<int:id>', views.sort_player_invitations, name="sortPlayerInvitations"),
    #     path('player/sort-history/<int:id>',
    #          views.sort_player_history, name="sortPlayerHistory"),
    #     path('player/sort-friends/<int:id>',
    #          views.sort_player_friends, name="sortPlayerFriends"),
    ...
    path('delete-my-sport-hall/<int:id>',
         views.delete_sport_hall, name="deleteSportHall"),
